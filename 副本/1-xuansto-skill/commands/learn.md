...
| Agent角色 | 职责 | 参与阶段 |
|-----------|------|----------|
| Orchestrator | 学习流程协调 | 全流程 |
| system-architect | 架构模式学习 | 模式识别、知识提取 |
| code-reviewer | 代码模式学习 | 数据收集、知识提取 |
| refactoring-specialist | 重构模式学习 | 知识提取、验证 |
| test-architect | 测试模式学习 | 数据收集、验证 |
| technical-writer | 知识文档化 | 知识存储、报告阶段 |
