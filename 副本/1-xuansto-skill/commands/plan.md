...
| Agent | 角色 | 职责 |
|-------|------|------|
| Product Manager | 产品经理 | 任务优先级、里程碑定义 |
| System Architect | 系统架构师 | 技术依赖、架构决策 |
| Fullstack Engineer | 全栈工程师 | 工作量估算 |
| Test Architect | 测试架构师 | 测试策略、测试任务 |
| DevOps Engineer | DevOps工程师 | 部署任务、环境准备 |
