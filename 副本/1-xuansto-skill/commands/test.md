...
| Agent | 角色 | 测试类型 |
|-------|------|----------|
| Unit Tester | 单元测试工程师 | 单元测试 |
| Integration Tester | 集成测试工程师 | 集成测试 |
| E2E Tester | E2E测试工程师 | E2E测试 |
| Performance Tester | 性能测试工程师 | 性能测试 |
| Security Tester | 安全测试工程师 | 安全测试 |
| Test Architect | 测试架构师 | 测试策略 |
| Test Maintainer | 测试维护工程师 | 测试维护 |
