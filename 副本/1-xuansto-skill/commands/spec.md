...
| Agent | 角色 | 参与规格 |
|-------|------|----------|
| System Architect | 系统架构师 | 架构规格、技术选型 |
| Backend Developer | 后端工程师 | API规格、数据规格 |
| Database Engineer | 数据库工程师 | 数据模型、Schema |
| Security Auditor | 安全审计员 | 安全规格 |
| Technical Writer | 技术文档工程师 | 文档整理 |
