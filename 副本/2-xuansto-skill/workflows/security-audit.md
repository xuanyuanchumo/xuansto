  ...
  - id: phase-1
    ...
    quality_gates:
      - gate_id: all_code_scanned
        blocking: true
        pass_criteria: 审计范围已确认
  - id: phase-2
    name: 代码安全审查
    order: 2
    optional: false
    agents:
      primary: [security-auditor, code-reviewer]
      supporting: []
    quality_gates:
