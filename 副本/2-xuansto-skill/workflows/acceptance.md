...
phases:
  - id: phase-1
    ...
    agents:
      primary: [product-manager, test-architect]
      supporting: []
    quality_gates:
  ...
  - id: phase-2
    ...
    optional: false
    agents:
      primary: [e2e-tester, product-manager]
      supporting: []
    quality_gates:
  ...
  - id: phase-3
    ...
    optional: false
    agents:
      primary: [performance-tester, security-auditor]
      supporting: []
    quality_gates:
  ...
  - id: phase-3-5
    ...
    optional: true
    agents:
      primary: [desktop-developer, build-release-engineer]
      supporting: []
    quality_gates:
      - gate_id: desktop_install_pass
        blocking: true
        pass_criteria: 桌面安装验证通过
  - id: phase-3-6
    name: 自动更新验证
    order: 5
    optional: true
  ...
  - id: phase-3-7
    ...
    optional: true
    agents:
      primary: [desktop-developer]
      supporting: []
    quality_gates:
      - gate_id: cross_platform_pass
        blocking: true
        pass_criteria: 跨平台兼容性验证通过
  - id: phase-4
    name: 文档验收
    order: 7
    optional: false
    agents:
      primary: [documentation-engineer]
      supporting: []
    quality_gates:
...
agent_matrix:
  product-manager:
    phases: [phase-1, phase-2, phase-5, phase-6]
    role: primary
  ...
  test-architect:
    ...
    max_parallel_instances: 1
  e2e-tester:
    phases: [phase-2, phase-5, phase-6]
    role: primary
    max_parallel_instances: 1
  security-auditor:
    phases: [phase-3]
  ...
  documentation-engineer:
    ...
    max_parallel_instances: 1
  desktop-developer:
    phases: [phase-3-5, phase-3-6, phase-3-7]
    role: supporting
    max_parallel_instances: 1
  build-release-engineer:
    phases: [phase-3-5, phase-3-6]
    role: supporting
    max_parallel_instances: 1
exception_handling:
  phase_failure:
