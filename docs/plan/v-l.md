...
(原始 multi-agent-         + xuansto-mcp-server v8.0.0         + xuansto-mcp-server v9.0.0
 sdd-tdd-orchestrator)    (重构完成，42问题中34已解决)
                                    │
                                    ▼
                           ┌────────────────────┐
...
| 版本 | 阶段 | 预计周期 | 解决问题数 | 累计解决 | 状态 |
|------|------|---------|-----------|---------|------|
| v8.1.0 / v4.2.0 | P0 紧急修复 | 第 1 周 | 3 (U-01~U-03) | 3/42 | ✅ 已完成 |
| v8.2.0 / v4.3.0 | P1 接口治理 | 第 2-3 周 | 7 (U-04~U-10) | 10/42 | ✅ 已完成 |
| v8.3.0 / v4.4.0 | P2 架构加固 | 第 4-5 周 | 21 (U-11~U-31) | 31/42 | ✅ 大部分完成 |
| v8.4.0 / v4.5.0 | P3 优化收尾 | 第 6 周+ | 11 (U-32~U-42) | 42/42 | ✅ 大部分完成 |
| v8.0.0 / v8.0.0 | 重构整合发布 | — | 34/42 已解决 | 34/42 | ✅ 已发布 |
| v9.0.0 / v9.0.0 | 下一大版本 | 第 8 周+ | 新特性 + 破坏性变更 | — | 待规划 |
...
|-----------|----------------|---------|---------|
| v8.0.0 | v8.0.0 | v2.0.0 | 当前发布版（重构完成） |
...
| v9.0.0 | v9.0.0 | v3.0.0 | 不兼容 v8.x；需同时升级 Skill 和 MCP Server |

### 8.2 渐进式加载版本演进

| 版本 | Phase 0→1 | Phase 1→2 | Phase 2→3 | Token 降级 |
|------|-----------|-----------|-----------|-----------|
| v8.0.0 | 自动 | DisclosureTransition状态机 | DisclosureTransition状态机 | 手动触发 |
...
```
v8.0.0/v8.0.0 ────────────────────────────────────────────────────────────→ v9.0.0/v9.0.0
     │                                                                        │
     │   重构整合发布（已完成）                                                 │   下一大版本
     │   34/42问题已解决                                                       │   API v3
     │   MCP Server v8.0.0                                                    │   自动Phase推进
     │   19+ Tool + 8+ Resource                                               │   v1彻底清除
     │   统一xuansto.db                                                        │
     ▼                                                                        ▼
  重构完成基线                                                            下一大版本
```
