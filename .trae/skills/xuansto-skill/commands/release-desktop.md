...
- `scripts/sign-desktop.ps1` - 桌面应用签名脚本，执行代码签名和公证流程
- `scripts/verify-auto-update.ps1` - 自动更新验证脚本，验证自动更新检测和增量/全量更新流程

---

## 相关工作流

- `workflows/desktop-build-workflow.md` - 桌面构建工作流，定义桌面应用发布和分发的完整执行流程
